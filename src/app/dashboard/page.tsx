      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg p-6 mb-4">
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-white/90">Ready to analyze more videos?</p>
          </div>
          <button
            onClick={() => setIsModalOpen(true)}
            className="hidden md:inline-flex bg-white text-blue-600 px-4 py-2 rounded-lg font-medium hover:bg-white/90 transition-colors items-center gap-2"
          >
        ...
        <button
          onClick={() => setIsModalOpen(true)}
          className="md:hidden mt-4 bg-white text-blue-600 px-4 py-2 rounded-lg font-medium hover:bg-white/90 transition-colors inline-flex items-center gap-2"
        >
          <Plus className="w-5 h-5" />
          New Analysis
        </button>
